...
plot "corr-1.00-0.00-0.30-0.60.txt" u 1:3 w l title '\$\\theta = 0\$', \
	"corr-1.00-0.25-0.30-0.60.txt" u 1:3 w l title '\$\\theta = 0.25\$'
...
plot "corr-1.00-0.00-0.30-0.60.txt" u 1:4 w l title '\$\\theta = 0\$', \
	"corr-1.00-0.25-0.30-0.60.txt" u 1:4 w l title '\$\\theta = 0.25\$'
...
plot "corr-1.00-0.00-0.30-5.00.txt" u 1:3 w l title '\$\\theta = 0\$', \
	"corr-1.00-0.25-0.30-5.00.txt" u 1:3 w l title '\$\\theta = 0.25\$'

set key bot
set title '\$C^{(p)}_t\$'
set ylabel '\$\\langle p_0 p_t \\rangle - \\langle p_0 \\rangle\\langle p_t\\rangle\$'
plot "corr-1.00-0.00-0.30-5.00.txt" u 1:4 w l title '\$\\theta = 0\$', \
	"corr-1.00-0.25-0.30-5.00.txt" u 1:4 w l title '\$\\theta = 0.25\$'
...
set title '\$C^{(x)}_t\$'
set ylabel '\$\\langle x_0 x_t \\rangle - \\langle x_0 \\rangle\\langle x_t\\rangle\$'
plot "corr-1.50-0.23-0.30-0.60.txt" u 1:3 w l lt 2 title '\$\\theta = 0.23\$', \
	"corr-1.50-0.00-0.30-0.60.txt" u 1:3 w l lt 1title '\$\\theta = 0\$'

set key bot
set title '\$C^{(p)}_t\$'
set ylabel '\$\\langle p_0 p_t \\rangle - \\langle p_0 \\rangle\\langle p_t\\rangle\$'
plot "corr-1.50-0.23-0.30-0.60.txt" u 1:4 w l lt 2 title '\$\\theta = 0.23\$', \
...
plot "corr-0.41-0.00-0.30-0.60.txt" u 1:3 w l title '\$\\theta = 0\$', \
	"corr-0.41-0.25-0.30-0.60.txt" u 1:3 w l title '\$\\theta = 0.25\$'

set key bot
set title '\$C^{(p)}_t\$'
set ylabel '\$\\langle p_0 p_t \\rangle - \\langle p_0 \\rangle\\langle p_t\\rangle\$'
plot "corr-0.41-0.00-0.30-0.60.txt" u 1:4 w l title '\$\\theta = 0\$', \
	"corr-0.41-0.25-0.30-0.60.txt" u 1:4 w l title '\$\\theta = 0.25\$'
